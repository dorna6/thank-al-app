...
class vars {
  ...
  static ThemeData lightTheme = ThemeData(
      ...
      colorScheme: ColorScheme.light(
        background: Color(0xFFf6f6f8), // background color
        primary: Color(0xFFffffff), // menu line color
        secondary: Color(0xFF000000), // text color
        shadow: Color(0xFFe3e3e3), // shadow
      )
  );
...
// dark theme
  static ThemeData darkTheme = ThemeData(
      ...
      colorScheme: ColorScheme.dark(
        background: Color(0xFF202020), // background color
        primary: Color(0xFF2B2B2B), // menu line color
        secondary: Color(0xFFffffff), // text color
        shadow: Color(0xFF2B2B2B), // shadow
      )
  );


  // vars
  static final double longSpace = 50.0;
  static final double shortSpace = 20.0;
  static final double veryShortSpace = 2.0;
