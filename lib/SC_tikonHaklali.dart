...
class SC_tikonHaklali extends StatelessWidget {
  const SC_tikonHaklali({super.key});
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Align(
          ...
          child: Text('התיקון הכללי', style: textStyleAppbar),
        ),
      ),
      body: Scrollbar(
        child: Padding(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(children: [
              ...
              //                 _scrollController.position.maxScrollExtent / 14.5 ,
              //                 duration: const Duration(milliseconds: 500),
              //                 curve: Curves.ease,
              //               );
              //             },
              //             child: Text('תיקון הכללי',style: textStyleButton),
              //             style: ElevatedButton.styleFrom(
              //               backgroundColor: Color(0xFFb8b8c7),
              //             ),
              //           ),
              //         ),
              //       ),
              ...
              //           onPressed: () {
              //             _scrollController.animateTo(
              //               _scrollController.position.maxScrollExtent / 1.72 ,
              //               duration: const Duration(milliseconds: 500),
              //               curve: Curves.ease,
              //             );
              //           },
              //           child: Text('תפילת רבי רתן',style: textStyleButton),
              //           style: ElevatedButton.styleFrom(
              //             backgroundColor: Color(0xFFb8b8c7),
              //           ),
              //         ),
              ...
              CustomRichText(
                textSpan: TextSpan(
                  children: <TextSpan>[
                    TextSpan(
                      text:
                      "טוב לומר נוסח זה להיתקשרות לצדיק לפני אמירת התיקון הכללי.",
                      style: textStyleSimpleText2,
                    ),
                  ],
                ),
              ...
              CustomRichText(
                textSpan: TextSpan(
                  children: <TextSpan>[
                    ...
                    TextSpan(
                      text:
                      "מִצַּר תִּצְּרֵנִי רָנֵּי פַלֵּט תְּסוֹבְבֵנִי סֶלָה",
                      style: textStyleSimpleText,
                    ),
                    TextSpan(
                      text: endOfPasokStr,
              ...
              CustomRichText(
                textSpan: TextSpan(
                  children: <TextSpan>[
                    TextSpan(
                      text:
                      'ב"אלהים" יכוון השם במילוי אלף למד אלף למד הי יוד מם',
                      style: textStyleSimpleText2,
                    ),
                  ],
                ),
              ...
              CustomRichText(
                textSpan: TextSpan(
                  children: <TextSpan>[
                    TextSpan(
                      text:
                      'תפלת רבי נתן משער החמשים, לאומרה לאחר התיקון הכללי',
                      style: textStyleSimpleTextHeadline,
                    ),
                  ],
                ),
              ...
              CustomRichText(
                textSpan: TextSpan(
                  children: <TextSpan>[
                    TextSpan(
                      text:
                      'רִבּוֹנוֹ שֶׁל עוֹלָם! רִבּוֹנוֹ שֶׁל עוֹלָם! מָלֵא'
              ...
              CustomRichText(
                textSpan: TextSpan(
                  children: <TextSpan>[
                    ...
                    TextSpan(
                      text:
                      ', וְרַחֵם עָלַי, וְתֶן לִי כֹּחַ וּגְבוּרָה מֵאִתְּךָ,'
